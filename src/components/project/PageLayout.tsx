      ...
      >
        <header className="flex flex-wrap items-start justify-between gap-4 border-b border-line pb-5">
          <div className="min-w-0">
            ...
            {lead && (
              <p className="mt-1.5 max-w-3xl text-[13.5px] leading-relaxed text-ink-muted">
                {lead}
              </p>
            )}
          </div>
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-panel border border-line bg-surface px-6 py-5 shadow-panel">
        <h2 className="text-[13px] font-semibold text-ink">What this section will contain</h2>
      ...
      <div className="rounded-panel border border-attention-line bg-attention-soft/50 px-6 py-5">
        <h2 className="text-[13px] font-semibold text-ink">Why it is not ready</h2>
        <p className="mt-2 max-w-3xl text-[13px] leading-relaxed text-ink-muted">{whyNotReady}</p>
